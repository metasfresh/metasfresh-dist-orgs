-- 07.03.2017 17:50
-- URL zum Konzept
INSERT INTO C_BPartner (AcqusitionCost,AD_Client_ID,AD_Language,AD_Org_ID,AllowConsolidateInOut,C_BPartner_ID,C_BP_Group_ID,C_PaymentTerm_ID,Created,CreatedBy,
	CreateSO,CreditorId,DebtorId,DeliveryRule,DeliveryViaRule,DocumentCopies,EdiDESADVDefaultItemCapacity,FlatDiscount,Fresh_AllowLineDiscount,Fresh_IsPrintESR,Fresh_Produzentenabrechnung,Fresh_Urproduzent,InvoiceRule,IsActive,IsADRCustomer,IsADRVendor,IsCompany,IsCreateDefaultPOReference,IsCustomer,IsDisableOrderCheckup,IsDiscountPrinted,IsEdiRecipient,IsEmployee,IsHidePackingMaterialInShipmentPrint,IsOneTime,IsParentSponsorReadWrite,IsPlanning,IsPOTaxExempt,IsProducerAllotment,IsProspect,IsReplicationLookupDefault,IsSalesRep,IsShippingNotificationEmail,
	IsSummary,IsTaxExempt,IsVendor,M_FreightCost_ID,M_PriceList_ID,M_PricingSystem_ID,M_Warehouse_ID,Name,NumberEmployees,PaymentRule,PaymentRulePO,
	PotentialLifeTimeValue,SalesVolume,
	SendEMail,ShareOfCustomer,ShelfLifeMinPct,SO_CreditLimit,Updated,UpdatedBy,Value) 
VALUES (0,1000000,'de_CH',540002,'Y',540006,1000000,1000002,TO_TIMESTAMP('2017-03-07 17:50:23','YYYY-MM-DD HH24:MI:SS'),100,
	'N',0,0,'F','P',0,1,0,'N','N','N','N','D','Y','N','N','N','N','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N',
	'N','N','N',1000000,2001003,2000837,540008,'sektion 1',0,'P','P',
	0,0,
	'N',0,0,0,TO_TIMESTAMP('2017-03-07 17:50:23','YYYY-MM-DD HH24:MI:SS'),100,'1000003')
;
...
IsSummary,IsTaxExempt,IsVendor,M_FreightCost_ID,M_PriceList_ID,M_PricingSystem_ID,M_Warehouse_ID,Name,NumberEmployees,PaymentRule,PaymentRulePO,
PotentialLifeTimeValue,SalesVolume,SendEMail,ShareOfCustomer,ShelfLifeMinPct,SO_CreditLimit,Updated,UpdatedBy,Value) 
VALUES (0,1000000,'de_CH',540003,'Y',540007,1000000,1000002,TO_TIMESTAMP('2017-03-07 17:50:48','YYYY-MM-DD HH24:MI:SS'),100,'N',0,0,'F','P',0,1,0,'N','N','N','N','D','Y','N','N','N','N','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N',
'N','N','N',1000000,2001003,2000837,540008,'sektion 2',0,'P','P',
0,0,'N',0,0,0,TO_TIMESTAMP('2017-03-07 17:50:48','YYYY-MM-DD HH24:MI:SS'),100,'1000004')
;
