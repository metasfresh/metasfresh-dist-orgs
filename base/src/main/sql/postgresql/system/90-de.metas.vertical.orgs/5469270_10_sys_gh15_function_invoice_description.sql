-- Function: de_metas_endcustomer_fresh_reports.docs_sales_orgs_invoice_description(numeric, character varying)

-- DROP FUNCTION de_metas_endcustomer_fresh_reports.docs_sales_orgs_invoice_description(numeric, character varying);
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION de_metas_endcustomer_fresh_reports.docs_sales_orgs_invoice_description(numeric, character varying)
  OWNER TO metasfresh;
