...
<ul>
	...
	<li><a href=\"${mvnConf.deployRepoURL}/de/metas/dist/metasfresh-orgs-dist/${misc.urlEncode(MF_VERSION)}/metasfresh-orgs-dist-${misc.urlEncode(MF_VERSION)}-sql-only.tar.gz\">sql-only-tar.gz</a></li>
	<li><a href=\"${mvnConf.deployRepoURL}/de/metas/dist/metasfresh-orgs-swingui/${misc.urlEncode(MF_VERSION)}/metasfresh-orgs-swingui-${misc.urlEncode(MF_VERSION)}-client.zip\">client.zip</a></li>
