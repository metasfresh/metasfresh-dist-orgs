	...
	configFileProvider([configFile(fileId: 'metasfresh-global-maven-settings', replaceTokens: true, variable: 'MAVEN_SETTINGS')])
	{
		...
		withMaven(jdk: 'java-8', maven: 'maven-3.3.9', mavenLocalRepo: '.repository')
		{
			stage('Set versions and build endcustomer-dist')
			{
				...
				sh "mvn --settings $MAVEN_SETTINGS --file dist/pom.xml --batch-mode ${MF_MAVEN_TASK_RESOLVE_PARAMS} org.codehaus.mojo:properties-maven-plugin:1.0.0:write-project-properties"
